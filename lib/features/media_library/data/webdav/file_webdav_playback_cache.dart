...
class FileWebDavPlaybackCache implements CloudPlaybackCache {
  FileWebDavPlaybackCache({
    ...
    this.expireAfter = const Duration(days: 7),
       ...
       _cacheDirectoryProvider =
           cacheDirectoryProvider ?? resolveWebDavCacheDirectory;
  ...
  Future<CloudCachedMedia> resolve({
    ...
    if (id.isEmpty) {
      throw StateError('WebDAV 歌曲 ${song.songId} 缺少 sourceSongId');
    }
